package com.javatechi.spring.cassandra.api.controller;
...
import com.javatechi.spring.cassandra.api.repository.UserRepository;
...
public class UserController {
	...
	public void saveUser() {
		...
		users.add(new User(9854, "Sanas", "Odisha", 25));
